...
const Surname = () => {
  ...
  return (
    <div className="relative w-full my-4">
      <input type="text" name='Prezime' id="floating_filled_surname" class="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50  border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
