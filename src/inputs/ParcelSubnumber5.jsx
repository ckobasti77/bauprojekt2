...
const ParcelSubnumber = () => {
  const { language, setParcelSubnumber5 } = useContext(ContextAll);
  ...
  return (
    <div className="relative w-3/6 z-0 group">
      <input
        type="number"
        name="Podbroj parcele 5"
        id="floating_filled_parcel_subnumber5"
        value={value}
        onChange={(e) => {
      ...
      />
      <label
        htmlFor="floating_filled_parcel_subnumber5"
        className={`${
          error.length > 0 && value.length > 0
